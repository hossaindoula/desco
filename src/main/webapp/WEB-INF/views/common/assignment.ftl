            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">${AssignmentType}</h4>
                    </div>
                ...
                <div class="col-sm-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form role="form" class="form-horizontal" action="/saveAssignment">
                                <div class="col-xs-5">
                                    <label>
                                        ${UnmapperName!}
                                    </label>
									<select name="from[]" id="undo_redo" class="form-control" size="13" multiple="multiple">
                                        <#if unmappers??>
                                            <#list unmappers as unmapper>
                                                <option value="${unmapper.id}">${unmapper.name}</option>
                                            </#list>
                                        </#if>
									</select>
								</div>
                                ...
                                <input type="hidden" id="whomTo" name="whomTo">
