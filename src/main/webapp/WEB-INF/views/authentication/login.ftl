...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="/assets/bower_components/bootstrap/dist/css/bootstrap.min.css" />
    <link type="text/css" rel="stylesheet" href="/assets/bower_components/font-awesome/css/font-awesome.min.css" />
    <link type="text/css" rel="stylesheet" href="/assets/fonts/clip-font.min.css" />
    <link type="text/css" rel="stylesheet" href="/assets/bower_components/iCheck/skins/all.css" />
    <link type="text/css" rel="stylesheet" href="/assets/bower_components/perfect-scrollbar/css/perfect-scrollbar.min.css" />
    <link type="text/css" rel="stylesheet" href="/assets/bower_components/sweetalert/dist/sweetalert.css" />
...
<div class="main-login col-sm-4 col-sm-offset-4">
    ...
    <div class="box-login">
        ...
        <form class="form-login" action="authenticateUser" method="POST">
            <#if message??>
...
<!-- Mirrored from www.cliptheme.com/preview/cliponeV2/Admin/clip-one-template/clip-one/login_example2.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 May 2016 07:21:17 GMT -->
</html>