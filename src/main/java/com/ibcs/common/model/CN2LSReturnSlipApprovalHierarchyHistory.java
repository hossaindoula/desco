...
@Entity
@Table(name = "CN2_LS_RS_APP_HIER_HIST")
public class CN2LSReturnSlipApprovalHierarchyHistory {
	@Id
	@Column(name = "Id")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "cn2ls_rs_app_hier_his_seq")
	@SequenceGenerator(name = "cn2ls_rs_app_hier_his_seq", sequenceName = "cn2ls_rs_app_hier_his_seq", allocationSize = 1, initialValue = 1)
	private Integer id;
