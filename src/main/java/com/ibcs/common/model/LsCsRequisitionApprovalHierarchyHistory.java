...
@Entity
@Table(name = "LS_CS_REQUIS_APP_HIER_HIST")
public class LsCsRequisitionApprovalHierarchyHistory {
	@Id
	@Column(name = "Id")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "ls_cs_requis_app_hier_his_Seq")
	@SequenceGenerator(name = "ls_cs_requis_app_hier_his_Seq", sequenceName = "ls_cs_requis_app_hier_his_Seq", allocationSize = 1, initialValue = 1)
	private Integer id;
