...
@Entity
@Table(name = "LS_SS_RS_APP_HIER_HIST")
public class LsSsReturnSlipApprovalHierarchyHistory {
	@Id
	@Column(name = "Id")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "ls_ss_rs_app_hier_his_seq")
	@SequenceGenerator(name = "ls_ss_rs_app_hier_his_seq", sequenceName = "ls_ss_rs_app_hier_his_seq", allocationSize = 1, initialValue = 1)
	private Integer id;
	
	// ls_cs_rs_app_hier_his_Seq
