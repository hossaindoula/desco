...
@Entity
@Table(name = "CN_SS_RS_APP_HIER_HIST")
public class CnSsReturnSlipApprovalHierarchyHistory {
	@Id
	@Column(name = "Id")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "cn_ss_rs_app_hier_his_seq")
	@SequenceGenerator(name = "cn_ss_rs_app_hier_his_seq", sequenceName = "cn_ss_rs_app_hier_his_seq", allocationSize = 1, initialValue = 1)
	private Integer id;
