...
@Entity
@Table(name = "LS_ST_APP_HIER_HIST")
public class LSStoreTicketApprovalHierarchyHistory {
	@Id
	@Column(name = "Id")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "ls_st_app_hier_his_seq")
	@SequenceGenerator(name = "ls_st_app_hier_his_seq", sequenceName = "ls_st_app_hier_his_seq", allocationSize = 1, initialValue = 1)
	private Integer id;
