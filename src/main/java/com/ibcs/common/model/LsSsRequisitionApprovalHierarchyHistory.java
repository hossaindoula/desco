...
@Entity
@Table(name = "LS_SS_REQUIS_APP_HIER_HIST")
public class LsSsRequisitionApprovalHierarchyHistory {
	@Id
	@Column(name = "Id")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "ls_ss_requis_app_hier_his_Seq")
	@SequenceGenerator(name = "ls_ss_requis_app_hier_his_Seq", sequenceName = "ls_ss_requis_app_hier_his_Seq", allocationSize = 1, initialValue = 1)
	private Integer id;
