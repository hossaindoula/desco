...
@Entity
@Table(name = "GATE_PASS_APP_HIER_HIST")
public class GatePassApprovalHierarchyHistory {
	@Id
	@Column(name = "Id")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "gp_hier_his_seq")
	@SequenceGenerator(name = "gp_hier_his_seq", sequenceName = "gp_hier_his_seq", allocationSize = 1, initialValue = 1)
	private Integer id;
