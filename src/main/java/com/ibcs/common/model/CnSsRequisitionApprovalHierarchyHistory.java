...
@Entity
@Table(name = "CN_SS_REQUIS_APP_HIER_HIST")
public class CnSsRequisitionApprovalHierarchyHistory {
	@Id
	@Column(name = "Id")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "cn_ss_requis_app_hier_his_Seq")
	@SequenceGenerator(name = "cn_ss_requis_app_hier_his_Seq", sequenceName = "cn_ss_requis_app_hier_his_Seq", allocationSize = 1, initialValue = 1)
	private Integer id;
