...
@Entity
@Table(name = "STORE_TICKET_APP_HIER_HIST")
public class StoreTicketApprovalHierarchyHistory {
	@Id
	@Column(name = "Id")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "st_app_hier_his_seq")
	@SequenceGenerator(name = "st_app_hier_his_seq", sequenceName = "st_app_hier_his_seq", allocationSize = 1, initialValue = 1)
	private Integer id;
