...
@Entity
@Table(name = "KHATH_TRSF_APP_HIER_HIST")
public class KhathTransferApprovalHierarchyHistory {
	@Id
	@Column(name = "Id")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "khath_trsf_app_his_Seq")
	@SequenceGenerator(name = "khath_trsf_app_his_Seq", sequenceName = "khath_trsf_app_his_Seq", allocationSize = 1, initialValue = 1)
	private Integer id;
