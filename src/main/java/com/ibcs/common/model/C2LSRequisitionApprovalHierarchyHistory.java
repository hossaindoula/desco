...
@Entity
@Table(name = "C2_LS_REQUIS_APP_HIER_HIST")
public class C2LSRequisitionApprovalHierarchyHistory {
	@Id
	@Column(name = "Id")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "c2_ls_requis_app_hier_his_Seq")
	@SequenceGenerator(name = "c2_ls_requis_app_hier_his_Seq", sequenceName = "c2_ls_requis_app_hier_his_Seq", allocationSize = 1, initialValue = 1)
	private Integer id;
