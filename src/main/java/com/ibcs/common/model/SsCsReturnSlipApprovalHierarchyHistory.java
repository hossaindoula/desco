...
@Entity
@Table(name = "SS_CS_RS_APP_HIER_HIST")
public class SsCsReturnSlipApprovalHierarchyHistory {
	@Id
	@Column(name = "Id")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "ss_cs_rs_app_hier_his_seq")
	@SequenceGenerator(name = "ss_cs_rs_app_hier_his_seq", sequenceName = "ss_cs_rs_app_hier_his_seq", allocationSize = 1, initialValue = 1)
	private Integer id;
