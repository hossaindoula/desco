...
@Entity
@Table(name = "VEHICLE_PERMISSION")
public class VehiclePermission {

	@Id
	@Column(name = "Id")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "vehicle_permission_id_seq")
	@SequenceGenerator(name = "vehicle_permission_id_seq", sequenceName = "vehicle_permission_id_seq", allocationSize = 1, initialValue = 1)
