...
@Entity
@Table(name = "VP_APP_HIER_HIST")
public class VehiclePermissionApprovalHierarchyHistory {
	
	@Id
	@Column(name = "Id")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "vp_app_hier_his_seq")
	@SequenceGenerator(name = "vp_app_hier_his_seq", sequenceName = "vp_app_hier_his_seq", allocationSize = 1, initialValue = 1)
	private Integer id;
