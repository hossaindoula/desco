...
@Entity
@Table(name = "STORE_TICKET_DTL")
public class CSStoreTicketDtl {
	@Id
	@Column(name = "id")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "cs_st_dtl_id_seq")
	@SequenceGenerator(name = "cs_st_dtl_id_seq", sequenceName = "cs_st_dtl_id_seq", allocationSize = 1, initialValue = 1)
	private Integer id;
	...
	private CSStoreTicketMst csStoreTicketMst;
	...
	public CSStoreTicketMst getCsStoreTicketMst() {
		return csStoreTicketMst;
	}

	public void setCsStoreTicketMst(CSStoreTicketMst csStoreTicketMst) {
		this.csStoreTicketMst = csStoreTicketMst;
	}
