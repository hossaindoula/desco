...
@Entity
@Table(name = "ls_return_slip_dtl")
public class LSReturnSlipDtl {

	@Id
	@Column(name = "id")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "ls_str_tkt_dtl_seq")
	@SequenceGenerator(name = "ls_str_tkt_dtl_seq", sequenceName = "ls_str_tkt_dtl_seq", allocationSize = 1, initialValue = 1)
	private Integer id;
	...
	@ManyToOne
	@JoinColumn(name = "ls_return_slip_mst_id")
	private LSReturnSlipMst lsReturnSlipMst;

	@Transient
	private Integer lsReturnSlipMstId;
	...
	public LSReturnSlipMst getLsReturnSlipMst() {
		return lsReturnSlipMst;
	}

	public void setLsReturnSlipMst(LSReturnSlipMst lsReturnSlipMst) {
		this.lsReturnSlipMst = lsReturnSlipMst;
	}

	public Integer getLsReturnSlipMstId() {
		return lsReturnSlipMstId;
	}

	public void setLsReturnSlipMstId(Integer lsReturnSlipMstId) {
		this.lsReturnSlipMstId = lsReturnSlipMstId;
	}
