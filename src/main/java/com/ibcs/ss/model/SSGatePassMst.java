...
@Entity
@Table(name = "SS_GATE_PASS_MST")
public class SSGatePassMst {

	@Id
	@Column(name = "id")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "ss_gp_mst_id_seq")
	@SequenceGenerator(name = "ss_gp_mst_id_seq", sequenceName = "ss_gp_mst_id_seq", allocationSize = 1, initialValue = 1)
	private Integer id;
