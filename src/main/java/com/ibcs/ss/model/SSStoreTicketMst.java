...
@Entity
@Table(name = "SS_STORE_TICKET_MST")
public class SSStoreTicketMst {

	@Id
	@Column(name = "id")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "ss_st_mst_id_seq")
	@SequenceGenerator(name = "ss_st_mst_id_seq", sequenceName = "ss_st_mst_id_seq", allocationSize = 1, initialValue = 1)
	private Integer id;
