...
import com.ibcs.cs.model.CSItemTransactionMst;

@Entity
@Table(name = "SS_ITEM_TNX_DTL")
public class SSItemTransactionDtl {
	@Id
	@Column(name = "Id")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "ss_item_tran_dtl_seq")
	@SequenceGenerator(name = "ss_item_tran_dtl_seq", sequenceName = "ss_item_tran_dtl_seq", allocationSize = 1, initialValue = 1)
	...
	@ManyToOne
	@JoinColumn(name = "ss_itm_trn_mst_id", nullable = false)
	private SSItemTransactionMst ssItemTransactionMst;

	@Transient
	private Integer ssItemTransactionMstid;
	...
	public SSItemTransactionMst getSsItemTransactionMst() {
		return ssItemTransactionMst;
	}

	public void setSsItemTransactionMst(
			SSItemTransactionMst ssItemTransactionMst) {
		this.ssItemTransactionMst = ssItemTransactionMst;
	}

	public Integer getSsItemTransactionMstid() {
		return ssItemTransactionMstid;
	}

	public void setSsItemTransactionMstid(Integer ssItemTransactionMstid) {
		this.ssItemTransactionMstid = ssItemTransactionMstid;
	}
