...
@Entity
@Table(name = "SS_REQUISITION_MST")
public class SubStoreRequisitionMst {

	@Id
	@Column(name = "id")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "ss_requisition_mst_id_seq")
	@SequenceGenerator(name = "ss_requisition_mst_id_seq", sequenceName = "ss_requisition_mst_id_seq", allocationSize = 1, initialValue = 1)
	private Integer id;
	...
	public String toString() {
		return "SubStoreRequisitionMst [id=" + id + ", requisitionNo="
