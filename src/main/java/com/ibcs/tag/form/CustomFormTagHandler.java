 ...
 */
public class CustomFormTagHandler extends org.springframework.web.servlet.tags.form.AbstractHtmlElementTag {
     ...
     * @param tagWriter the {@link org.springframework.web.servlet.tags.form.TagWriter} to which the form content is to be written
     * @return {@link javax.servlet.jsp.tagext.Tag#EVAL_BODY_INCLUDE}
     */
    @Override
    protected int writeTagContent(org.springframework.web.servlet.tags.form.TagWriter tagWriter) throws JspException {
        ...
        if (StringUtils.hasText(action)) {
            ...
            if (response instanceof HttpServletResponse) {
                ...
                if (StringUtils.hasText(queryString)) {
                    requestUri += "?" + org.springframework.web.util.HtmlUtils.htmlEscape(queryString);
                }
            }
    ...
    /**
     * Process the action through a {@link org.springframework.web.servlet.support.RequestDataValueProcessor} instance
     * if one is configured or otherwise returns the action unmodified.
     */
    private String processAction(String action) {
        org.springframework.web.servlet.support.RequestDataValueProcessor processor = getRequestContext().getRequestDataValueProcessor();
