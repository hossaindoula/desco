...
import com.ibcs.tag.ajax.helpers.XMLUtils;
...
public class AjaxDisplayTag extends AjaxAreaTag {
     ...
     *
     * Parse content to XHTML {@link Document}, rewrite DisplayTag anchor elements and
     ...
     * @see net.sourceforge.ajaxtags.tags.AjaxAreaTag#processContent(String)
     */
    @Override
