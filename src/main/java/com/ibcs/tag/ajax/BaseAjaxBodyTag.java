...
import com.ibcs.tag.ajax.helpers.JavaScript;
import com.ibcs.tag.ajax.manager.AjaxActionManager;
 ...
 */
public class BaseAjaxBodyTag extends BodyTagSupport {
    ...
    public final int doStartTag() throws JspException {
        ...
        for (AjaxActionManager.HTMLAjaxHeader header : AjaxActionManager.HTMLAjaxHeader.values()) {
